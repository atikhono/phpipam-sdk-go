...
// CreateFirstFreeSubnet creates new child subnet inside subnet with specified mask by sendibg a POST request.
func (c *Controller) CreateFirstFreeSubnet(id int, mask int) (out string, err error) {
